...
CREATE INDEX IF NOT EXISTS idx_topic_segments_episode ON topic_segments(episode_id);
CREATE INDEX IF NOT EXISTS idx_topic_segments_embedding
  ON topic_segments USING hnsw (embedding vector_cosine_ops);
